...
namespace Dokimion.Pages
{
    internal class Settings
    {
        ...
        public static IWebLocator RemoveEnvironments => L("RemoveEnvironments",
            By.XPath("(//label[contains(text(),'Environments')]//following-sibling::div//div[@class='css-16pqwjk-indicatorContainer'])[1]"));
           // By.XPath("(//*[local-name()='svg' and @class='css-19bqh2r'])[6]"));
