...
Logger.info("BaseCrudResource::findOne() - projectId: " + projectId);
Logger.info("BaseCrudResource::findOne() - entity id: " + id);
        //return getService().findOne(getUserSession(), projectId, id);

        E entity = getService().findOne(getUserSession(), projectId, id);
Logger.info("BaseCrudResource::findOne - entity: " + entity);
...
Logger.info("BaseCrudResource::create() - entity: " + entity);
        //return getService().save(getUserSession(), projectId, entity);
Logger.info("BaseCrudResource::create - user session: " + getUserSession());
        E new_entity = getService().save(getUserSession(), projectId, entity);
Logger.info("BaseCrudResource::create - new entity: " + new_entity);
        return new_entity;
    }
...
Logger.info("BaseCrudResource:delete - projectId, launchId: " + projectId + ", " + id);

        getService().delete(getUserSession(), projectId, id);

Logger.info("BaseCrudResource:delete - after call to service.delete");
        return ok().build();
    }
