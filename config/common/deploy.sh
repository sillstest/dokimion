...
if [ $1 == "s1" ]
then
  cp ~1/config/staging/s-dokimion1/startup_dokimion_server.sh ../bin/.
fi
if [ $1 == "s2" ]
then
  cp ~1/config/staging/s-dokimion2/startup_dokimion_server.sh ../bin/.
fi
if [ $1 == "s3" ]
then
  cp ~1/config/staging/s-dokimion3/startup_dokimion_server.sh ../bin/.
fi
